...
| - | - | - | - | - |
|**US-01**|Visualizar información de la startup y testimonios|<p>Como usuario visitante, quiero acceder a la descripción de la empresa y leer opiniones de usuarios para confirmar la calidad del servicio.</p>|<p>**Escenario 1:** Información consolidada</p><p>Dado que navego en la página,</p><p>Cuando hago scroll por el contenido,</p><p>Entonces leo sobre la democratización de la domótica y los testimonios de clientes reales.</p>**Escenario 2:** <br>Error de carga de testimonio <br>Dado que la base de datos de testimonios no responde, Cuando accedo a la sección de opiniones, Entonces la interfaz muestra la información general y oculta la sección de testimonios rotos para no afectar la estética visual.|**EP-05**|
|**US-02**|Motor de búsqueda inteligente|<p>Como usuario visitante, quiero usar una barra de búsqueda para encontrar secciones de la página rápidamente.</p>|<p>**Escenario 1:** Búsqueda exitosa</p><p>Dado que busco información de costos,</p><p>Cuando escribo "precios" y doy clic a la lupa,</p><p>Entonces la página hace un scroll suave hacia "Our Plans".</p>**Escenario 2:** Búsqueda sin resultados Dado que escribo una palabra que no existe en el sitio (ej. "computadoras"), Cuando doy clic a la lupa, Entonces la barra tiembla visualmente y muestra un mensaje flotante que dice: "No se encontraron secciones con ese término".|**EP-05**|
|**US-03**|Cambio de idioma (ES/EN)|<p>Como usuario visitante, quiero poder cambiar el idioma de la página web para leerla en mi idioma nativo.</p>|<p>**Escenario 1:** Traducción dinámica</p><p>Dado que la página está en inglés,</p><p>Cuando doy clic al ícono del mundo (ES),</p><p>Entonces todos los textos cambian instantáneamente al español.</p>**Escenario 2:** <br>Fallo en la carga del archivo de traducción Dado que hay un error de red al descargar el diccionario de idiomas,Cuando selecciono cambiar a "EN",Entonces el sistema mantiene el idioma actual por defecto y muestra un aviso sutil: "Idioma no disponible temporalmente".|**EP-05**|
|**US-04**|Suscripción al boletín de noticias|<p>Como usuario visitante, quiero suscribirme al boletín en un formulario para recibir consejos de ahorro y ofertas.</p>|<p>**Escenario 1:** Envío de formulario</p><p>Dado que ingreso mi email en la sección de contacto,</p><p>Cuando presiono "Submit",</p><p>Entonces aparece un mensaje de agradecimiento temporal y la caja se limpia.</p>**Escenario 2**<br>Formato de correo inválido Dado que ingreso un texto sin estructura de correo (ej. "usuario#gmail.com"), Cuando presiono "Submit",Entonces el borde del formulario se vuelve rojo y muestra: "Por favor, introduce un correo electrónico válido".|**EP-05**|
|**US-05**|Interfaz interactiva (Menú y Audio)|<p>Como usuario visitante, quiero interactuar con un menú fluido y pausar/reproducir la música de fondo a mi gusto.</p>|<p>**Escenario 1:** Navegación y control</p><p>Dado que estoy en la web,</p><p>Cuando uso el Navbar dinámico o presiono el botón flotante de audio,</p><p>Entonces la página me redirige a la sección deseada o pausa la música (ElectroCorp.mp3).</p>**Escenario 2**<br>Archivo de audio inaccesible Dado que el archivo de audio no se encuentra en el servidor o falla su carga, Cuando presiono el botón de reproducción, Entonces el botón cambia a un estado deshabilitado (gris) con un ícono de advertencia para no congelar la navegación.|**EP-05**|
|**US-06**|Comparar planes de servicio|<p>Como usuario visitante, quiero ver las diferencias entre el plan Free y Enterprise para elegir el adecuado.</p>|<p>**Escenario 1:** Tarjetas de precio</p><p>Dado que bajo a la sección "Pricing",</p><p>Cuando visualizo las tarjetas,</p><p>Entonces noto que el plan Enterprise está resaltado como premium.</p>**Escenario 2**<br>Error en la carga de tarifas Dado que las tarifas de la API no cargan debido a un error del servidor, Cuando accedo a la sección, Entonces las tarjetas muestran precios estáticos por defecto en lugar de quedarse en blanco o con valores indefinidos.|**EP-05**|
...
|**US-11**|Ver estado en tiempo real|<p>Como usuario, quiero ver si un dispositivo está encendido o apagado.</p>|<p>**Escenario 1:** Feedback visual</p><p>Dado que el usuario observa el dashboard,</p><p>Cuando un equipo cambia de estado físico,</p><p>Entonces el icono se actualiza en la app.</p>**Escenario 2:**<br>Pérdida intermitente de señal del hardware Dado que el dispositivo pierde conexión por unos segundos, Cuando la app detecta falta de respuesta,Entonces el ícono del dispositivo se vuelve semitransparente con una etiqueta de "Estado desconocido / Desconectado".|**EP-02**|
...
|**US-14**|Crear rutinas automáticas|<p>Como usuario, quiero definir rutinas de automatización general.</p>|<p>**Escenario 1:** Rutina nocturna</p><p>Dado que el usuario crea una rutina "Dormir",</p><p>Cuando llega la hora programada,</p><p>Entonces todos los dispositivos seleccionados se apagan a la vez.</p>**Escenario 2**<br>Error en la ejecución parcial de la rutina Dado que 1 de los 5 dispositivos incluidos en la rutina "Dormir" está desconectado físicamente, Cuando se ejecuta la rutina,Entonces el sistema apaga los 4 dispositivos operativos y envía una notificación: "Rutina ejecutada parcialmente. El dispositivo 'Terma' no respondió".|**EP-02**|
...
|**US-18**|Ver recomendaciones de ahorro|<p>Como usuario, quiero recibir sugerencias para ahorrar energía.</p>|<p>**Escenario 1:** Tips inteligentes</p><p>Dado que el consumo es ineficiente en cierto horario,</p><p>Cuando revisa el panel de sugerencias,</p><p>Entonces el sistema recomienda crear nuevas rutinas.</p>**Escenario**<br>Datos insuficientes para generar el algoritmo Dado que el sistema tiene menos de 24 horas recopilando información, Cuando el usuario entra a ver las sugerencias de optimización, Entonces el sistema muestra: "Estamos analizando tus hábitos. Tus primeras recomendaciones de ahorro estarán listas en 48 horas".|**EP-03**|
...
|**US-21**|Bloquear acceso no autorizado|<p>Como usuario, quiero proteger mi cuenta de extraños.</p>|<p>**Escenario 1:** Timeout por inactividad</p><p>Dado que la app web queda abierta sin interactuar,</p><p>Cuando pasan 30 minutos sin uso,</p><p>Entonces la sesión expira.</p>**Escenario 2:**<br>Intento de violación de sesión expirada Dado que la sesión ya caducó por inactividad,Cuando un tercero intenta realizar una acción de apagado dándole clic al botón que quedó pintado en pantalla, Entonces la aplicación bloquea el comando, borra los datos locales y redirige forzosamente a la pantalla de Login.|**EP-04**|
...
|**US-27**|Pagar suscripción con tarjeta|<p>Como usuario, quiero ingresar mi tarjeta de forma segura para adquirir el plan Premium.</p>|<p>**Escenario 1:** Pasarela Stripe</p><p>Dado que el usuario elige el plan Enterprise,</p><p>Cuando ingresa sus datos válidos,</p><p>Entonces Stripe procesa exitosamente el cobro mensual.</p>**Escenario 2:**<br>Tarjeta rechazada o fondos insuficientes Dado que la tarjeta ingresada no cuenta con saldo o está vencida, Cuando Stripe procesa la transacción, Entonces el sistema bloquea la actualización de la cuenta, mantiene al usuario en el plan gratuito y muestra la alerta: "Pago rechazado por su entidad bancaria".|**EP-06**|
...
|**US-32**|Editar perfil de usuario|<p>Como usuario, quiero cambiar mis datos personales de perfil.</p>|<p>**Escenario 1:** Guardado de cambios</p><p>Dado que el usuario edita su nombre o teléfono,</p><p>Cuando da clic en guardar,</p><p>Entonces la información se actualiza en la base de datos MySQL.</p>**Escenario 2** <br>Pérdida de conexión a mitad de la actualización Dado que el internet se corta justo al presionar "Guardar", Cuando la API de actualización de datos de perfil devuelve un error de timeout, Entonces la app mantiene los datos escritos en los inputs en lugar de borrarlos y advierte: "No se pudieron guardar los cambios. Reintentando cuando vuelva la conexión".|**EP-04**|
...
|**US-36**|Filtrar historial por fechas|<p>Como usuario, quiero establecer un rango de fechas para ver consumos pasados.</p>|<p>**Escenario 1:** Filtro de calendario</p><p>Dado que el usuario abre la herramienta de fechas,</p><p>Cuando selecciona desde y hasta,</p><p>Entonces la gráfica se redibuja excluyendo el resto de días.</p>**Escenario 2:**<br>Rango de fechas invertido o ilógico Dado que el usuario selecciona una fecha de inicio que es cronológicamente posterior a la fecha de fin (ej. Desde: 20 de mayo, Hasta: 10 de mayo), Cuando presiona filtrar,Entonces el sistema bloquea la búsqueda, resalta las cajas en rojo y muestra: "La fecha inicial debe ser anterior a la fecha final".|**EP-03**|
...
|**US-38**|Agrupar dispositivos|<p>Como usuario, quiero agrupar mis enchufes por habitaciones.</p>|<p>**Escenario 1:** Operación masiva por grupo</p><p>Dado que el usuario ha creado el grupo "Iluminación Sala",</p><p>Cuando apaga el grupo,</p><p>Entonces todos los enchufes asignados a la sala se apagan simultáneamente.</p>**Escenario 2**<br>Eliminación de un grupo activo Dado que un usuario decide borrar el grupo llamado "Cocina", Cuando confirma la eliminación de la etiqueta del grupo, Entonces el sistema disuelve la agrupación sin borrar los dispositivos, los cuales regresan automáticamente a la categoría general de "Dispositivos individuales" para no perder su control|**EP-02**|
...
|**US-40**|Gestionar múltiples locales|<p>Como dueño de negocio, quiero gestionar distintas sucursales desde una sola cuenta centralizada.</p>|<p>**Escenario 1:** Selector de Sucursal</p><p>Dado que el usuario posee el plan Enterprise,</p><p>Cuando despliega el menú de ubicaciones superior,</p><p>Entonces puede saltar del "Local A" al "Local B" cambiando el dashboard.</p>**Escenario 2**<br>Degradación de plan con múltiples locales activos Dado que el dueño canceló su suscripción Enterprise y regresó al plan Free (el cual solo permite 1 local), Cuando intenta iniciar sesión, Entonces el sistema congela los paneles secundarios, mantiene accesible únicamente el local más antiguo y despliega un aviso de reactivación para recuperar el acceso a las demás sucursales.|**EP-04**|
